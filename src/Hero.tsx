      ...
      <div className="space-y-20 lg:space-x-5">
        ...
        <div className="flex justify-between items-center gap-20 px-8 lg:px-10 xl:px-20 py-5">
          <div className="flex flex-col   justify-center items-center lg:justify-between lg:items-start w-full gap-10 lg:gap-7 xl:gap-10 -mt-10">
            <h1 className="text-white text-3xl md:text-4xl  lg:text-4xl xl:text-[60px]/[120%] font-semibold text-center lg:text-left tracking-tight lg:max-w-full xl:max-w-xl">
          ...
          <img
            src={herobg}
            alt=""
            className="-mb-11 hidden   lg:block lg:w-[500px] xl:w-[570px] "
          />
        </div>
        <div className="w-full absolute top-0 bottom-0 -mt-5 lg:-mt-5 xl:mt-23 lg:top-[760px] xl:top-[730px] lg:bottom-[45px] ">
          <p className="text-center text-[#9CA2C5] text-sm/[24px] tracking-wider hidden lg:block ">
            ACCESS SIMPLIFIED! NO KEYS, NO CARDS, NO FINGERPRINTS — JUST SCAN
          </p>
        </div>
        <p className=" p-5 text-center text-[#9CA2C5] text-xs md:text-sm/[24px] tracking-wider block lg:hidden ">
          ACCESS SIMPLIFIED! NO KEYS, NO CARDS, NO FINGERPRINTS — JUST SCAN
        </p>

...
export const SectionEight = () => {
  return (
    <div className="container py-15 px-5 md:px-10 lg:15px xl:px-20 md:py-20 xl:py-20 mx-auto -mb-90 relative z-10 ">
         <div className="flex px-20 py-30 flex-col justify-center items-center bg-[#007BFF] space-y-4 rounded-2xl z-1000">
            ...
            <button className="flex gap-2 text-[#007BFF] max-w-[160px] bg-white rounded-full px-5 py-3">
    <p>Get a Demo</p>
